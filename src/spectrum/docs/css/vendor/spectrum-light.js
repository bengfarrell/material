...
---
name: Alert - Closable
description: An Alert with a close button in the footer. Combine this strategy with any variant.
ignoreDNA: true
markup: |
...
description: A small, indeterminate circle loader
ignoreDNA: true
markup: |
...
description: A large, indeterminate circle loader
ignoreDNA: true
markup: |
...
description: A Spectrum loader of default type (round) for using over a background color.
markup: |
...
description: An full-page indeterminate circle loader
ignoreDNA: true
markup: |
  <div style="width: 200px; height: 200px; background-color: rgba(0,0,0,0.4); display: flex; align-items: center; justify-content: center;">
...
components:
  dialog-alert-confirmation:
    ...
    status: Verified
    description: An confirmation alert dialog has specific button styles that should be used.
  ...
  dialog-alert-information:
    ...
    status: Verified
    description: An information alert dialog has specific button styles that should be used.
    demoClassName: cssdocs-Overlay-example
    markup: |
  ...
  dialog-alert-destructive:
    ...
    status: Verified
    description: An destructive alert dialog has specific button styles that should be used.
    demoClassName: cssdocs-Overlay-example
    markup: |
...
components:
  ...
  tabs-too-many-compact:
    ...
    markup: |
      <div class="spectrum-Tabs spectrum-Tabs--horizontal spectrum-Tabs--quiet spectrum-Tabs--compact">
        <div class="spectrum-Tabs-item is-selected" tabindex="0">
          <label class="spectrum-Tabs-itemLabel">Tab 1</label>
        </div>
        <div class="spectrum-Tabs-item" tabindex="0">
...
description: The a/b toggle variant of the switch.
ignoreDNA: true
status: Verified
markup: |
...
description: Horizontal SplitView
markup: |
...
description: Horizontally resizable SplitView with gripper
markup: |
  <div class="spectrum-SplitView spectrum-SplitView--horizontal" style="height: 200px">
    <div class="spectrum-SplitView-pane" style="width: 304px">Left</div>
...
description: Vertically resizable SplitView with gripper
markup: |
...
description: Horizontally collapsed SplitView
markup: |
  <div class="spectrum-SplitView spectrum-SplitView--horizontal" style="height: 200px">
...
description: Vertically collapsed SplitView
markup: |
  <div class="spectrum-SplitView spectrum-SplitView--vertical" style="height: 200px">
...
description: The IllustratedMessage component, used for status and errors.
markup: |
...
description: The IllustratedMessage component, used for instruction/call to action.
markup: |
  <div class="spectrum-IllustratedMessage spectrum-IllustratedMessage--cta">
    <svg class="spectrum-IllustratedMessage-illustration" width="199" height="98" viewBox="0 0 199 97.7"><defs><style>.cls-1,.cls-2{fill:none;stroke-linecap:round;stroke-linejoin:round;}.cls-1{stroke-width:3px;}.cls-2{stroke-width:2px;}</style></defs><path class="cls-1" d="M110.53,85.66,100.26,95.89a1.09,1.09,0,0,1-1.52,0L88.47,85.66"/><line class="cls-1" x1="99.5" y1="95.5" x2="99.5" y2="58.5"/><path class="cls-1" d="M105.5,73.5h19a2,2,0,0,0,2-2v-43"/><path class="cls-1" d="M126.5,22.5h-19a2,2,0,0,1-2-2V1.5h-31a2,2,0,0,0-2,2v68a2,2,0,0,0,2,2h19"/><line class="cls-1" x1="105.5" y1="1.5" x2="126.5" y2="22.5"/><path class="cls-2" d="M47.93,50.49a5,5,0,1,0-4.83-5A4.93,4.93,0,0,0,47.93,50.49Z"/><path class="cls-2" d="M36.6,65.93,42.05,60A2.06,2.06,0,0,1,45,60l12.68,13.2"/><path class="cls-2" d="M3.14,73.23,22.42,53.76a1.65,1.65,0,0,1,2.38,0l19.05,19.7"/><path class="cls-1" d="M139.5,36.5H196A1.49,1.49,0,0,1,197.5,38V72A1.49,1.49,0,0,1,196,73.5H141A1.49,1.49,0,0,1,139.5,72V32A1.49,1.49,0,0,1,141,30.5H154a2.43,2.43,0,0,1,1.67.66l6,5.66"/><rect class="cls-1" x="1.5" y="34.5" width="58" height="39" rx="2" ry="2"/></svg>
    <h2 class="spectrum-Heading spectrum-Heading--pageTitle spectrum-IllustratedMessage-heading">Drag and Drop Your File</h2>
...
description: Standard cards will full-sized asset previews are not supported, don't do this.
status: Unsupported
markup: |
  <div style="width: 208px;">
    <div class="spectrum-Card">
...
/*! topdoc
name: Card - Small
description: Small cards are not supported, don't do this.
status: Unsupported
markup: |
  <div style="width: 208px;">
...
description: A spectrum Quiet Card for an image
status: Beta
markup: |
...
description: A spectrum Quiet Card for a folder asset
status: Beta
markup: |
  <div style="width: 208px; height: 264px;">
    <div class="spectrum-Card spectrum-Card--quiet">
...
description: A spectrum Quiet Card for a file asset
status: Beta
markup: |
  <div style="width: 208px; height: 264px;">
    <div class="spectrum-Card spectrum-Card--quiet">
...
/* topdoc
name: Card - Gallery
description: A spectrum gallery card for an image
status: Beta
markup: |
...
directory: button
filename: button-quiet-secondary
*/
...
description: Displays a buffer for video players.
markup: |
  <div class="spectrum-Slider">
    <div class="spectrum-Slider-labelContainer">
...
description: A dial for turning it up to 11, now with labels.
ignoreDNA: true
markup: |
  <div class="spectrum-Dial">
...
---
name: Tabs - Compact
description: Compact tabs should never be used without the quiet variation. Please use [Quiet Compact Tabs instead](#tabs---quiet-compact).
status: Deprecated
components:
  tabs-compact:
    name: Compact tabs
...
components:
  ...
  tabs-quiet-compact-icons:
    name: Quiet compact tabs with icons and text
    markup: |
      <div class="spectrum-Tabs spectrum-Tabs--horizontal spectrum-Tabs--compact spectrum-Tabs--quiet">
        <div class="spectrum-Tabs-item is-selected" tabindex="0">
          <svg class="spectrum-Icon spectrum-Icon--sizeS" focusable="false" aria-hidden="true" aria-label="Folder">
  ...
  tabs-quiet-compact-icon-only:
    name: Quiet compact tabs with icons only
    markup: |
      <div class="spectrum-Tabs spectrum-Tabs--horizontal spectrum-Tabs--compact spectrum-Tabs--quiet">
        <div class="spectrum-Tabs-item is-selected" tabindex="0">
          <svg class="spectrum-Icon spectrum-Icon--sizeS" focusable="false" aria-hidden="true" aria-label="Folder">
...
components:
  ...
  tabs-vertical-icon-only:
    name: Compact vertical tabs with icon only
    markup: |
      <div class="spectrum-Tabs spectrum-Tabs--vertical spectrum-Tabs--compact">
        <div class="spectrum-Tabs-item is-selected" tabindex="0">
          <svg class="spectrum-Icon spectrum-Icon--sizeS" focusable="false" aria-hidden="true" aria-label="Folder">
...
description: The quiet variant of the Switch.
ignoreDNA: true
status: Verified
markup: |
...
---
name: Stepper
description: Note that you must manually apply the `.is-focused` class, and that the `.is-focused` styles below don't look correct unless your cursor is actually in the stepper input field.
status: Deprecated
markup: |
  <div class="spectrum-Stepper">
...
---
name: Stepper - Quiet
description: The quiet variant of the Stepper.
status: Deprecated
markup: |
...
---
name: Rating
description: The Rating element.
ignoreDNA: true
markup: |
...
id: rating
name: Rating - Active
description: The active state of the Rating element.
ignoreDNA: true
markup: |
  <div class="spectrum-Rating">
...
description: The disabled state of the Rating element.
ignoreDNA: true
markup: |
